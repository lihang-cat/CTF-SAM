...
🔗 Download Dataset & Weights from Google Drive
...
Quantitative Metrics: Calculates Dice Score and NSD (Tolerance=2.0) for every dataset and organ.

Report Generation: Prints a global macro-average report in the terminal and exports results to clipsamnet_macro_results.csv.

Qualitative Analysis: Saves visual samples (Image with prompt, Ground Truth, and Prediction) to vis_results_v1/normal_samples/.