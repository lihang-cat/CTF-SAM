...
DATASET_ROOT = r"D:\dataset\TestDataset-20260214T102211Z-1-001\TestDataset\C13_CVC-300"
OUTPUT_DIR = r"E:\code\Med-CLIP-SAM\data\processed\CVC_300_256_Expert_Std"
...
CVC300_EXPERT_DESC = "colon polyp, a protruding growth on the inner lining of the colon, appearing reddish and textured"
...
def process_single_pair(args):
    ...
    try:
        ...
        file_base_id = f"cvc_300_{file_id}"
        ...
        return {
            ...
            "description": CVC300_EXPERT_DESC,
            "organ": ORGAN_NAME,
...
def main():
    ...
    print(f"🚀 Starting CVC-300 (EndoScene) Preprocessing")
